  ...
  return (
      <div className="flex justify-center w-full">
        {step && 
            ...
            <div className="text-lg md:text-2xl text-[#1C1C1C] mb-2">Are you currently managing any chronic condition?</div>
            <div className="text-[#444444] text-[14px] ">Are you currently managing any chronic condition at this time or have you ever managed any chronic condition?</div>
        </div>
        }
        {!step && 
